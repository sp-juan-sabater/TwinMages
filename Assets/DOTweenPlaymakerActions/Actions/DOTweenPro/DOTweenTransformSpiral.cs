...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformSpiral : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOSpiral(duration.Value, axis.Value, spiralMode, speed.Value, frequency.Value, depth.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Transform Spiral");
