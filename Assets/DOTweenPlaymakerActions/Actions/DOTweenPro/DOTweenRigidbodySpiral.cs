...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbodySpiral : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody>().DOSpiral(duration.Value, axis.Value, spiralMode, speed.Value, frequency.Value, depth.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Rigidbody Spiral");
